...
const AllDrawings = () => {
  ...
  if (!drawings?.length) {
    return <div className='flex flex-col justify-center items-center mt-[10%]' >
      <svg aria-hidden="true" className="inline w-12 h-12 animate-spin text-gray-600 fill-purple-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <h1 className='text-3xl font-bold text-center'>No drawings</h1>
    </div>
  }
  return (
    <div
